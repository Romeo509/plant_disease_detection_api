...
def analyze_plant():
    ...
    "Use this fixed list of known maize problems to classify the image:\n"
    "- Maize Streak Virus (yellowish streaks on leaves, stunted growth)\n"
    "- Northern Corn Leaf Blight (long, gray/tan, cigar-shaped leaf lesions on lower leaves)\n"
    "- Common Rust (many small, reddish-brown spots or pustules scattered on leaves)\n"
    "- Fall Armyworm (chewed or windowed leaves, frass in whorls, visible larvae)\n"
    "- Stem Borers (holes in stalks or cobs, broken stems, weak plants)\n"
    "- Maize Weevils (damaged or holed grains, post-harvest stage)\n\n"
    "**Do not guess**. You must match visible symptoms only to one of these.\n"
    "If no disease or pest is visible, clearly say: 'Healthy'.\n"
    "If the image is not a maize plant, reply with:\n"
    "1. Plant type: Not maize\n"
    "2. Disease status: Not applicable\n"
    "3. Control or treatment: Not applicable\n\n"
    "**Rules:**\n"
    "- Never say just 'caterpillar' or 'worm' — say 'Fall Armyworm' if it's a match.\n"
    "- Do not say 'Common Rust' unless you clearly see round reddish pustules.\n"
    "- Only one diagnosis per image.\n\n"
    "Give control or treatment in 2–3 lines, using methods suitable for Ghanaian farmers:\n"
    "- Approved pesticides (e.g., emamectin benzoate, neem, tebuconazole)\n"
    "- Planting early, crop rotation, drying and storage, resistant varieties\n"
    "- Clean fields, remove infected plants\n\n"
